		...
		function wallpress_post_setting_callback( $post ) {
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="33%">
						<label>
							<input type="radio" name="wallpress_post_ribbon_setting" value="diary" <?php if ($ribbon_value == 'diary') echo 'checked="checked"' ?>>
							<span><?php _e('Diary','dw-wallpress') ?></span>
						</label>
					</td>
				</tr>
				<tr>
					<td width="33%">
						<label>
							<input type="radio" name="wallpress_post_ribbon_setting" value="product" <?php if ($ribbon_value == 'product') echo 'checked="checked"' ?>>
							<span><?php _e('Product','dw-wallpress') ?></span>
						</label>
					</td>
					
					<td width="33%">
						<label>
							<input type="radio" name="wallpress_post_ribbon_setting" value="intro" <?php if ($ribbon_value == 'intro') echo 'checked="checked"' ?>>
							<span><?php _e('Intro','dw-wallpress') ?></span>
						</label>
					</td>
					
					<td width="33%">
						<label>
							<input type="radio" name="wallpress_post_ribbon_setting" value="que" <?php if ($ribbon_value == 'que') echo 'checked="checked"' ?>>
							<span><?php _e('???','dw-wallpress') ?></span>
						</label>
					</td>
				</tr>
				<tr>
					<td width="33%">
						<label>
							<input type="radio" name="wallpress_post_ribbon_setting" value="gogo" <?php if ($ribbon_value == 'que') echo 'checked="checked"' ?>>
							<span><?php _e('GOGO','dw-wallpress') ?></span>
						</label>
					</td>
				</tr>
			</table>
